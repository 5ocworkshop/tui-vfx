...
pub fn print_usage() {
  ...
  tui-vfx-player-cli implementation-readiness --legacy-root PATH --v31-root PATH [--descriptor-pack PATH] [--descriptor-pack-dir DIR] [--family NAME | --recursive] [--json] [--include-blockers]
  tui-vfx-player-cli control-catalog [--descriptor-pack PATH] [--descriptor-pack-dir DIR] [--recipe PATH] [--json]"
    );
}
