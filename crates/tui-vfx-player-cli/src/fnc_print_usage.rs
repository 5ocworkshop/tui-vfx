...
// <WCTX>Primitive adapter work: document adapter gap command.</WCTX>
// <CLOG>0.5.0: MINOR — include primitive-adapter-gap command shape.
// 0.4.0: MINOR — include render-frame command shape.</CLOG>
