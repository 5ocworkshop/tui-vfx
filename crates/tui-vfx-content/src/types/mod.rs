...
// <WCTX>Add public mechanical cycle config types so Odometer/SplitFlap recipes can opt into ordered/circular face traversal.</WCTX>
// <CLOG>1.13.0: register and re-export mechanical cycle source/route/cascade/config modules.</CLOG>

pub mod cls_content_effect;
pub mod cls_dissolve_config;
pub mod cls_glyph_cascade;
pub mod cls_mechanical_cycle_cascade;
pub mod cls_mechanical_cycle_config;
pub mod cls_mechanical_cycle_route;
pub mod cls_mechanical_cycle_source;
...
pub use cls_mechanical_cycle_cascade::{
    EasingCurveName, MechanicalCascadePolicy, MechanicalSettleConfig, UnchangedCellPolicy,
};
pub use cls_mechanical_cycle_config::MechanicalCycleConfig;
pub use cls_mechanical_cycle_route::{
    CycleDirectionPolicy, CycleMissingFacePolicy, CycleTieBreaker, MechanicalRouteConfig,
};
pub use cls_mechanical_cycle_source::{
    CycleWrapMode, MechanicalContentSource, MechanicalCyclePreset, WeightedCycleFace,
};
