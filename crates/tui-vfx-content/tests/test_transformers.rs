...
#[path = "transformers/test_cls_numeric.rs"]
mod test_cls_numeric;
#[path = "transformers/test_cls_odometer.rs"]
mod test_cls_odometer;
#[path = "transformers/test_cls_redact.rs"]
mod test_cls_redact;
#[path = "transformers/test_cls_scramble.rs"]
