...
// <WCTX>New kernel Phase E1: expose minimal effect descriptor contract vocabulary.</WCTX>
// <CLOG>0.2.0: MINOR — export EffectDescriptor and descriptor capability DTOs/schema root.
