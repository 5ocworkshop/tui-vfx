// <FILE>crates/tui-vfx-compositor-next/tests/test_inspection_sink_bridge_per_stage.rs</FILE> - <DESC>Bridge round-trip test for the four new per-stage CompositorInspector callbacks landing in Pipeline observability Unit A</DESC>
...
// <FILE>crates/tui-vfx-compositor-next/tests/test_inspection_sink_bridge_per_stage.rs</FILE> - <DESC>Bridge round-trip test for new per-stage callbacks</DESC>
