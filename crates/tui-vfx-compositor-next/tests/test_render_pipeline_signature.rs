// <FILE>crates/tui-vfx-compositor-next/tests/test_render_pipeline_signature.rs</FILE> - <DESC>Compile-time signature assertions — this test file compiling is itself evidence that render_pipeline accepts the role-aware parameter tuple (&Grid, &RoleMap, &mut SemanticScene, …)</DESC>
...
// <FILE>crates/tui-vfx-compositor-next/tests/test_render_pipeline_signature.rs</FILE>
