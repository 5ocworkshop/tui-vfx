// <FILE>crates/tui-vfx-compositor-next/tests/test_inspection_sink_bridge.rs</FILE> - <DESC>Integration test: installing an InspectionSinkBridge on render_pipeline produces TraceEvents; existing CompositorInspector impls keep working</DESC>
...
use tui_vfx_compositor_next::traits::pipeline_inspector::CompositorInspector;
...
// <FILE>crates/tui-vfx-compositor-next/tests/test_inspection_sink_bridge.rs</FILE> - <DESC>Bridge integration test</DESC>
// <VERS>END OF VERSION: 0.1.0</VERS>

#[test]
fn bridge_reports_v3_family_in_shader_label_when_available() {
    use tui_vfx_compositor_next::pipeline::cls_composition_options::ShaderWithRegion;
