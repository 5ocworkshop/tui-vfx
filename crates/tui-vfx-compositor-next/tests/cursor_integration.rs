// <FILE>crates/tui-vfx-compositor-next/tests/cursor_integration.rs</FILE> - <DESC>End-to-end cursor rendering integration</DESC>
...
use tui_vfx_compositor_next::pipeline::{CompositionSpec, ShaderLayerSpec};
