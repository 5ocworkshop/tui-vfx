// <FILE>crates/tui-vfx-compositor-next/tests/test_render_pipeline_role_awareness.rs</FILE> - <DESC>Role-aware pipeline integration tests: asserts StyleRegion::Role(...) shaders target only the cells whose source role matches</DESC>
...
use tui_vfx_compositor_next::pipeline::{CompositionOptions, render_pipeline};
...
// <FILE>crates/tui-vfx-compositor-next/tests/test_render_pipeline_role_awareness.rs</FILE>
