// <FILE>crates/tui-vfx-compositor-next/tests/pipeline/test_orc_render_pipeline.rs</FILE> - <DESC>L2 render pipeline tests with Grid trait</DESC>
...
use std::borrow::Cow;
use tui_vfx_compositor_next::pipeline::{CompositionOptions, ShadowSpec};
    ...
    render_pipeline_legacy(
        ...
        CompositionOptions::default()
            ...
            .with_playback_timing(
                tui_vfx_compositor_next::pipeline::CompositionPlaybackTiming::new(1.0, None, None),
            ),
        None,
    );
    render_pipeline_legacy(
