// <FILE>crates/tui-vfx-compositor-next/tests/pipeline/test_helpers.rs</FILE> - <DESC>Test-only helpers that wrap the role-aware render_pipeline* entrypoints with the legacy `&mut OwnedGrid` call shape, so existing test bodies migrate by renaming the function call rather than restructuring</DESC>
...
// <FILE>crates/tui-vfx-compositor-next/tests/pipeline/test_helpers.rs</FILE>
