// <FILE>tui-vfx-compositor-next/tests/pipeline/test_multiple_effects.rs</FILE> - <DESC>Tests for multiple masks, filters, shaders</DESC>
...
// <CLOG>1.3.1: drop local `mod test_helpers;` declaration; pull from crate root (test_pipeline.rs declares once) to clear clippy::duplicate_mod.</CLOG>

#[allow(unused_imports)]
use crate::test_helpers::{render_pipeline_legacy, render_pipeline_with_spec_legacy};

use smallvec::{SmallVec, smallvec};
use tui_vfx_compositor_next::types::{FilterSpec, MaskCombineMode, MaskSpec, WipeDirection};
...
fn test_smallvec_filter_no_heap_for_three() {
    ...
    let filters: SmallVec<[FilterSpec; 3]> = smallvec![
        ...
        FilterSpec::Invert {
            apply_to: tui_vfx_compositor_next::types::ApplyTo::Foreground,
        },
        FilterSpec::Crt {
...
use tui_vfx_compositor_next::pipeline::check_masks;
