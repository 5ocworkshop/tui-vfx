// <FILE>tui-vfx-compositor-next/tests/types/test_shader_layer_spec.rs</FILE> - <DESC>Tests for ShaderLayerSpec V3 family lowering helpers</DESC>
...
use tui_vfx_compositor_next::pipeline::ShaderLayerSpec;
