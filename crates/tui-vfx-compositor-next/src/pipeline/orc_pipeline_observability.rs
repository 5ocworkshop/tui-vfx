// <FILE>crates/tui-vfx-compositor-next/src/pipeline/orc_pipeline_observability.rs</FILE> - <DESC>Per-stage observability emit helpers for render_loop_inspected and the shadow path's element pass</DESC>
...
// <FILE>crates/tui-vfx-compositor-next/src/pipeline/orc_pipeline_observability.rs</FILE> - <DESC>Per-stage observability emit helpers</DESC>
