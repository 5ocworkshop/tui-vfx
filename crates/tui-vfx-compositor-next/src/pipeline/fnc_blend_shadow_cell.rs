// <FILE>crates/tui-vfx-compositor-next/src/pipeline/fnc_blend_shadow_cell.rs</FILE> - <DESC>Glyph-overlay shadow blending helper shared by compositor adapters</DESC>
