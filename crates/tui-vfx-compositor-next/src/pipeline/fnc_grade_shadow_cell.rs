// <FILE>crates/tui-vfx-compositor-next/src/pipeline/fnc_grade_shadow_cell.rs</FILE> - <DESC>Destination-preserving color grading for grade-underlying shadow mode</DESC>
