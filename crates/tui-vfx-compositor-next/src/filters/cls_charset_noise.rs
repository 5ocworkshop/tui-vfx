// <FILE>tui-vfx-compositor-next/src/filters/cls_charset_noise.rs</FILE> - <DESC>Non-converging time-varying character replacement filter with vertical gradient</DESC>
