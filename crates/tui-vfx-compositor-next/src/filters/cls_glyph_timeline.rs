// <FILE>tui-vfx-compositor-next/src/filters/cls_glyph_timeline.rs</FILE> - <DESC>Per-cell discrete-frame, variable-dwell, one-shot glyph + color timeline filter for TTE-style scripted scenes</DESC>
...
// <FILE>tui-vfx-compositor-next/src/filters/cls_glyph_timeline.rs</FILE>
