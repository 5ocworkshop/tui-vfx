// <FILE>tui-vfx-compositor-next/src/filters/cls_animated_glyph_ramp.rs</FILE> - <DESC>Synchronised glyph + colour cycling filter driven by one shared phase signal</DESC>
