// <FILE>crates/tui-vfx-compositor-next/src/filters/cls_cell_color_intensity_signal.rs</FILE>
...
///
/// ```rust,ignore
/// use tui_vfx_compositor_next::filters::cls_cell_color_intensity_signal::CellColorIntensitySignal;
/// use tui_vfx_compositor_next::filters::cls_subcell_light::LightSampleFrom;
