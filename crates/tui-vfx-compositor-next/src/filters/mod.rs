// <FILE>tui-vfx-compositor-next/src/filters/mod.rs</FILE> - <DESC>Filter implementations (internal)</DESC>
...
pub(crate) mod cls_cell_color_intensity_signal;
...
pub(crate) mod cls_scalar_field_glyph_filter;
