// <FILE>tui-vfx-compositor-next/src/types/mask_combine_mode.rs</FILE> - <DESC>Mask composition mode for multiple masks</DESC>
...
///
/// ```
/// use tui_vfx_compositor_next::types::MaskCombineMode;
///
