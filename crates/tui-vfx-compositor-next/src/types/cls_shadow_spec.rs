// <FILE>crates/tui-vfx-compositor-next/src/types/cls_shadow_spec.rs</FILE> - <DESC>Shadow specification for compositor pipeline</DESC>
...
///
/// ```ignore
/// use tui_vfx_compositor_next::pipeline::CompositionOptions;
