// <FILE>crates/tui-vfx-compositor/tests/test_shadow_stage_emits.rs</FILE> - <DESC>Shadow path emits a Shadow StageEntered/StageFinished pair around the shadow buffer render</DESC>
...
// <FILE>crates/tui-vfx-compositor/tests/test_shadow_stage_emits.rs</FILE> - <DESC>Shadow path per-stage emit test</DESC>
