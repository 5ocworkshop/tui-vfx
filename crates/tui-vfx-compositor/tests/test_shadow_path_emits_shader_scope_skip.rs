// <FILE>crates/tui-vfx-compositor/tests/test_shadow_path_emits_shader_scope_skip.rs</FILE> - <DESC>Shadow path's element pass emits StageSkipped { ScopeMatchedZeroCells } for a Role(Text) shader on an all-Background role map — closes architect-flagged B2</DESC>
...
// <FILE>crates/tui-vfx-compositor/tests/test_shadow_path_emits_shader_scope_skip.rs</FILE> - <DESC>Shadow path shader scope-skip regression test</DESC>
