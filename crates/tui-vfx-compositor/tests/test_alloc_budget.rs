// <FILE>crates/tui-vfx-compositor/tests/test_alloc_budget.rs</FILE> - <DESC>Steady-state allocation-count gate for render_pipeline_with_shadow, protecting the Phase 1a + 1b wins (buffer pool, role-map Arc cache, region-resolution hoist, element-rect hoist)</DESC>
...
// <FILE>crates/tui-vfx-compositor/tests/test_alloc_budget.rs</FILE>
