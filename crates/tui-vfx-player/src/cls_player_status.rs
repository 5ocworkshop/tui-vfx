...
// <WCTX>New kernel Phase K0: classify rendered, unsupported, and error frame reports.</WCTX>
...
pub enum PlayerStatus {
    /// The supported K0 adapter subset rendered the frame.
    Rendered,
    /// The recipe is valid but needs an adapter that K0 does not implement.
    Unsupported,
