...
pub(crate) fn collect_handled_primitive_inputs(
    ...
    match descriptor_id {
        ...
        "mask.materialize" => fields(["origin", "softEdge", "chunkSize", "noise", "seed"]),
        ...
        "content.typewriter" => fields(["speed", "speedVariance", "cursorCharacter"]),
        "content.marquee" => fields(["speed", "direction", "width"]),
        "content.splitFlap" => fields(["settle", "cascade"]),
