...
// <CLOG>0.2.0: MINOR — classify K2.5 styled primitive adapters as rendered styled-cell support.
// 0.1.1: PATCH — clarify styled-cell blocker reason after substrate support landed.
...
fn outcome_for_effect(
    ...
    match effect.adapter_status.as_str() {
        ...
        "styled" => (
            "rendered",
            "styledCell",
            "The player emits deterministic styled-cell evidence for this effect.",
        ),
