...
// <WCTX>Only migrated shader slices are wired here; non-canonical shader DTO vocabulary stays out.</WCTX>
// <CLOG>0.1.1: PATCH — remove non-canonical migration vocabulary from metadata.
// 0.1.0: INIT — add linearGradient native shader module.</CLOG>
