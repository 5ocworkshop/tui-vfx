...
// <WCTX>Element orchestration materializes source, clips placement, applies effects, and returns observability evidence.</WCTX>
// <CLOG>0.4.0: MINOR — return diagnostics for skipped fully clipped elements.
...
pub(crate) fn render_scene_element(
    ...
    let applied_effect_kinds = effect_stack.applied_effect_kinds();
