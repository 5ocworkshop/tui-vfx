...
// <CLOG>0.4.0: MINOR — add source.procedural materialization module.
// 0.3.0: MINOR — add source.text materialization module.
// 0.2.1: PATCH — keep source module exports limited to the descriptor dispatch seam.
...
mod fnc_procedural_source_grid_from_inputs;
mod fnc_source_grid_from_inputs;
mod fnc_text_source_grid_from_inputs;
