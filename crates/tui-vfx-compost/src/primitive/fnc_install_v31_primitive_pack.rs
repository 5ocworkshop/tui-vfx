...
// <CLOG>0.10.0: MINOR — install sampler.sineWave alongside existing primitive ports.
...
use crate::samplers::{SamplerBounce, SamplerGravity, SamplerPendulum, SamplerSineWave};
