...
// <WCTX>Phase 0/1 of Rust-SSOT primitive migration: expose descriptor/runtime substrate while concrete ports live in domain directories matching the legacy reference hierarchy.</WCTX>
// <CLOG>0.2.0: MINOR — route the v3.1 primitive pack install entrypoint to domain-directory ports; concrete implementations stay outside primitive/.
