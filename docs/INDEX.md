...
<!-- <WCTX>Add canonical recipe authoring and visual QA docs to the engine docs index</WCTX> -->
<!-- <CLOG>MINOR: Link the new recipe authoring workflow and recipe visual QA guides alongside the existing probe and validator documentation</CLOG> -->
