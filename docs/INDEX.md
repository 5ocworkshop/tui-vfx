...
- [new_kernel/V31_PARALLEL_MIGRATION_LANE_RESULTS.md](new_kernel/V31_PARALLEL_MIGRATION_LANE_RESULTS.md) — Accepted recipe changes, verification evidence, and blocker map from the first parallel migration lanes.
