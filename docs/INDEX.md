...
<!-- <WCTX>Add the terminal water shader plan to discoverable documentation indexes.</WCTX> -->
<!-- <CLOG>1.16.0: add terminal water/ocean shader implementation plan pointer.
