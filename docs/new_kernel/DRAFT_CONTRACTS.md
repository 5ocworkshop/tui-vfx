<!-- <FILE>docs/new_kernel/DRAFT_CONTRACTS.md</FILE> - <DESC>Draft v3.1 contract discussion for clean-room kernel planning</DESC> -->
<!-- <VERS>VERSION: 0.1.0</VERS> -->
<!-- <WCTX>Original draft contract discussion used to orient new-kernel phases.</WCTX> -->
