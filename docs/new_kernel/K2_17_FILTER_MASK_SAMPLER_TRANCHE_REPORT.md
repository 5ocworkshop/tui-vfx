# K2.17 Filter Mask Sampler Tranche Report

Filter/mask/sampler work added descriptors, adapters, and fixtures for vignette, bracket emphasis, dot indicator, edge grow, hover bar, KITT scanner, underline wipe, sub-pixel bar, cellular mask, corner wipe/materialize, CRT sampler, and CRT jitter.

All authored fields used by canonical fixtures are descriptor-declared and player-handled.
