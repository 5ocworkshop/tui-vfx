# K2.17 Render Backend Seam Report

The player owns a `PlayerRenderBackend` seam with deterministic text-grid and styled-cell backends. Render IR remains the player-owned handoff object for future compositor/UI lowering. No compositor, ratatui, or GUI dependency is introduced into player core.
