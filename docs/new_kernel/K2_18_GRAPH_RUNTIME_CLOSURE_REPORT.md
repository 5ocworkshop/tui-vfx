<!-- <FILE>docs/new_kernel/K2_18_GRAPH_RUNTIME_CLOSURE_REPORT.md</FILE> - <DESC>K2.18 graph runtime backlog report</DESC> -->
...
# K2_18_GRAPH_RUNTIME_CLOSURE_REPORT

## Result

Graph runtime closure is incomplete: 87 active graph runtime rows remain.
