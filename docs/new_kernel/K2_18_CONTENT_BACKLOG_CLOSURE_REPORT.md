<!-- <FILE>docs/new_kernel/K2_18_CONTENT_BACKLOG_CLOSURE_REPORT.md</FILE> - <DESC>K2.18 content backlog report</DESC> -->
...
# K2_18_CONTENT_BACKLOG_CLOSURE_REPORT

## Result

Content closure is incomplete: 35 active content backlog rows remain; backend-heavy content rows are separate signed holdbacks.
