...
<!-- <WCTX>New kernel Phase F1: add typed input/value gate and F2 deferral.</WCTX> -->
<!-- <CLOG>0.7.0: MINOR — add Phase F1 typed input/value checks and F2 deferral.
...
- Value sources, parameters, signals, bindings, recipe nodes, studio controls, runtime graphs, migration, and real effect ports are still deferred.
