...
<!-- <WCTX>K2.13 schema decision burn-down: add schema-readiness, optional input, gradient, sampled-field, and built-in-scope gates.</WCTX> -->
<!-- <CLOG>0.17.0: MINOR — add player implementation-readiness, control-catalog, content/source vocabulary, and backend-seam gates.
