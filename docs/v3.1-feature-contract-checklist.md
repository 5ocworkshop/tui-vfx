...
<!-- <WCTX>New kernel Phase D3: add contract/proof boundary gate before descriptor work.</WCTX> -->
<!-- <CLOG>0.4.0: MINOR — add D3 contract/engine boundary questions and proof-artifact guardrails.
...
Current D3 guardrails:

- `Surface`, `Scene`, `ScopeSpec`, write policies, sampler semantics, and diagnostics are stable vocabulary.
...
- Descriptor implementation starts later, after the boundary is documented.
