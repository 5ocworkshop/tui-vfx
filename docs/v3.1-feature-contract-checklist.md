...
<!-- <WCTX>New kernel Phase D2: align checklist with template composition design locks.</WCTX> -->
<!-- <CLOG>0.3.0: MINOR — add D2 template composition rules for presets, profiles, overrides, provenance, and canonical recipes.
