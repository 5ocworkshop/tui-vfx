...
<!-- <WCTX>New kernel Phase H1: add canonical recipe document and vocabulary gate.</WCTX> -->
<!-- <CLOG>0.14.0: MINOR — add Phase H1 canonical recipe document and vocabulary checks.
