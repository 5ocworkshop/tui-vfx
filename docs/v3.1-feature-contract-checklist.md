...
<!-- <WCTX>New kernel Phase G3: add topology and parallel merge gate.</WCTX> -->
<!-- <CLOG>0.11.0: MINOR — add Phase G3 topology and channel-aware merge checks.
...
- Runtime parameter/signal stores, direct node/effect-input bindings, recipe nodes, studio controls, runtime graphs, migration, and real effect ports are still deferred.
