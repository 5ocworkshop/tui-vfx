...
<!-- <WCTX>New kernel Phase E0: require stable DTOs/schemas to land in tui-vfx-contract.</WCTX> -->
<!-- <CLOG>0.5.0: MINOR — add physical contract crate routing to contract-change gate.
...
- Descriptor implementation starts later, in `tui-vfx-contract`, after the physical split.
