...
<!-- <WCTX>New kernel Phase G4: add graph value bus gate.</WCTX> -->
<!-- <CLOG>0.12.0: MINOR — add Phase G4 node output and graph value bus checks.
...
- Runtime parameter/signal stores, F2 binding execution, direct node/effect-input bindings, recipe nodes, studio controls, production runtime graphs, asset/procedural sources, migration, and real effect ports are still deferred.
