...
<!-- <WCTX>K2.21 source-isolated native playback: add source-substrate and runtime override gates.</WCTX> -->
<!-- <CLOG>0.19.0: MINOR — add source render mode and runtime input override gates.
...
- Does stable vocabulary live in `tui-vfx-contract` (`RecipeDocument`, `RecipeMetadata`, `SourceInstanceId`, `RecipeScene`, `RecipeSceneElement`, and `RecipeElementPipeline`)?
