...
<!-- <WCTX>New kernel Phase D0: add schema-reference readiness to future feature classification.</WCTX> -->
<!-- <CLOG>0.1.0: INIT — preserve architect checklist text and add D0 schema/reference gates.</CLOG> -->
