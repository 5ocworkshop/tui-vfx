...
<!-- <WCTX>New kernel Phase E1: add descriptor capability gate and Phase F input deferral.</WCTX> -->
<!-- <CLOG>0.6.0: MINOR — add EffectDescriptor capability checks and full input/value deferral.
...
- Did the change avoid typed inputs, `ValueKind`, `ValueSource`, defaults, ranges, parameters, signals, bindings, recipe nodes, registries, runtime graphs, studio controls, migration, and real effect ports?
