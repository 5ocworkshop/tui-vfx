...
<!-- <WCTX>New kernel Phase F2: add declarative value source and binding gate.</WCTX> -->
<!-- <CLOG>0.8.0: MINOR — add Phase F2 value source, parameter, signal, and binding checks.
