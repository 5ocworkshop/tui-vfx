...
| 80 | [80_open_questions.md](80_open_questions.md) | Ledger for the remaining and recently closed plan-shaping questions. Q#21 recipe metadata and Q#23 timer policy are now accepted there; Q#22 motion-path/offscreen trajectory migration remains the notable active timing-adjacent question. | Evolving |
...
- `docs/design/history/tui-vfx-v3-upgrade-audit-workflow.md` — Workflows A / B / C referenced from `110_appendix_audits.md`
- `docs/design/history/tui-vfx-v3-ra-to-vfx-rename-inventory.md` — Working inventory for the Rust-side `Ra* -> Vfx*` rename adopted in Decision 4.
...
- `docs/design/history/tui-vfx-v3-upgrade-debug-recipes-migration-log.md` — The debug-recipes migration exercise that pressure-tested the draft schema. Contains the evolving schema-question journal (Q1–Q34), the running drift table (D1–D7), and the final V2↔V3 coverage audit.
