...
<!-- <CLOG>1.5.6: record that demo now exposes an explicit schema-version line in Recipe Info so mixed V2/V3 playback during cutover is obvious during audits.
...
<!-- <VERS>END OF VERSION: 1.5.6</VERS> -->
