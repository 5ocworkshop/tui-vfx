...
<!-- <CLOG>1.5.7: record that the direct compiled-V3 visual bridge now also applies non-spatial style effects, so the preferred playback path is no longer spatial-only.
...
<!-- <VERS>END OF VERSION: 1.5.7</VERS> -->
