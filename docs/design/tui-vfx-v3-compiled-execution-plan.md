...
- general arbitrary cross-family order preservation, starting with the parallel-join proof in `v3_io_parallel_merge_shader.json`
- final scheduling / batching strategy tracked in `tui-vfx-v3-scheduler-batching-plan.md` once the family coverage matrix is larger
