...
<!-- <CLOG>0.3.0: mark XFC-02 complete after the post-Parallel sampler/style-effect consumer proof landed in tui-vfx-recipes.
...
- XFC-01 has a committed cross-family sequence debug recipe and deterministic/probe/QC tests. XFC-02 has a committed post-Parallel sampler/style-effect consumer proof. Overlap/conflict behavior remains the XFC-03 follow-up.
