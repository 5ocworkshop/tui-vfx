...
<!-- <CLOG>1.13.0: record the first grouped-V3-to-legacy reverse lowering seam plus a runtime-facing ShaderLayerSpec constructor for grouped spatial families.
