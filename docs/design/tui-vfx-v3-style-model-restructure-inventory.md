...
<!-- <CLOG>1.7.0: add the first grouped V3 family seam for non-spatial style effects so runtime wiring can classify overall style effects through one SSOT family surface.
