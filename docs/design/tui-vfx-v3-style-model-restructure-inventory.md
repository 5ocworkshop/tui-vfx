...
<!-- <CLOG>1.23.0: record that AnimationProfile legacy fallback conversion now also consumes grouped V3 overall-effect values when synthesizing StyleLayer entries.
