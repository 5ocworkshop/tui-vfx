...
<!-- <CLOG>1.19.0: record broadened grouped-spatial runtime equivalence coverage across representative primitive and composed families in spec-driven rendering tests.
