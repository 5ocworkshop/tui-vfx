...
4. `shader.focusField` — signed off as the fourth direct v3.1 slice with ellipse/circle support, rect semantics explicitly unsupported, and integer-valued geometry required at load time.
